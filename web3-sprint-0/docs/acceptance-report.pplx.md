...
Це історичний звіт першого запуску до виправлення P1. Поточні результати після F01–F03 наведено в `docs/p1-fixes.pplx.md`, а їхні логи в `artifacts/p1/`; старі числа й coverage нижче не слід переносити на змінений контракт.
