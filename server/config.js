...
var SOURCES = {
  ...
  dpsu: { name: 'ДПСУ (Державна прикордонна служба України)', ttlMs: 5 * 60 * 1000, licence: 'No public API, HTML/JS map - throttle + attribute.', requiresKey: false, status: 'implemented' },
  granicaGovPl: { name: 'granica.gov.pl (KAS)', ttlMs: 3 * 60 * 60 * 1000, licence: 'No public API, HTML table (updates 8x/day) - throttle + attribute.', requiresKey: false, status: 'implemented' },
  meteoAlarm: { name: 'MeteoAlarm (EUMETNET)', ttlMs: 10 * 60 * 1000, licence: 'CC BY 4.0-equivalent, attribution required (see feed <rights>).', requiresKey: false, status: 'implemented' },
  aviationWeather: { name: 'AviationWeather.gov', ttlMs: 60 * 1000, licence: 'Free, US government public data.', requiresKey: false, status: 'implemented' },
