...
| `check_doc_counts.py` | Прогін D1–D7: числа й назви в документах ТЗ звірені з правилом гілки, конвеєрами та списками сценаріїв прогонів; 7 мутацій зістареної документації |
